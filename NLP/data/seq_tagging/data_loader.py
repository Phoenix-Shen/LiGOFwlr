...
def load_synthetic_data(args):
    ...
    # )
    tokenizer = tokenizer_class.from_pretrained(
        "pretrained_models/bert_tokenizer", do_lower_case=args.do_lower_case
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_file_path",
        type=str,
        default="../fednlp_data/data_files/20news_data.h5",
    ...
    parser.add_argument(
        "--partition_file_path",
        type=str,
        default="../fednlp_data/partition_files/20news_partition.h5",
